...
function tipomedicamento($x){foreach ($x as $tipe) {$id = $tipe['id'];$tipo_medic = $tipe['tipo_medic'];$descripcion = $tipe['descripcion'];echo "<option value='$id'>$descripcion</option>";}}
 ?>